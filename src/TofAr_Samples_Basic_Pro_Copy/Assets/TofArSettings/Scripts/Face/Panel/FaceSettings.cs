...
namespace TofArSettings.Face
{
    public class FaceSettings : UI.SettingsBase
    {
        ...
        BlendShapesSettingsController blendShapesSettingsController;

        UI.ItemDropdown itemMode, itemRuntimeMode, itemProcessModeLandmark;
        UI.ItemSlider itemThread;
        UI.ItemToggle itemStartStream, itemVRMBlendShapesEnable;
        ...
        protected override void Start()
        {
            ...
            blendShapesSettingsController = FindObjectOfType<BlendShapesSettingsController>();
            controllers.Add(blendShapesSettingsController);
        ...
        /// <summary>
        /// Make VRMBlendShapesEnable UI
        /// </summary>
        void MakeUIVRMBlendShapesEnable()
        {
            if (TofAr.V0.TofArManager.Instance.UsingIos)
            {
                itemVRMBlendShapesEnable = settings.AddItem("Enable VRM BlendShapes", blendShapesSettingsController.VRMBlendShapesEnable, ChangeVRMBlendShapesEnable);

                blendShapesSettingsController.OnChangeVRMBlendShapesEnable += (vrmBlendShapesEnable) =>
                {
                    itemVRMBlendShapesEnable.OnOff = vrmBlendShapesEnable;
                };
            }
        }

        /// <summary>
        /// Change VRMBlendShapesEnable settings
        /// </summary>
        /// <param name="val">Enable/Disable mirroring</param>
        void ChangeVRMBlendShapesEnable(bool val)
        {
            blendShapesSettingsController.VRMBlendShapesEnable = val;
        }
    }
}
